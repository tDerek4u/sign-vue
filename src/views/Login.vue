        ...
        <div class="flex justify-center items-center h-full">
          <div class="flex min-h-full w-full flex-col justify-center py-auto px-10 md:px-20 lg:px-20 xl:px-30">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
              <img class="mx-auto h-10 w-auto" src="../assets/images/ESingNewLogo 1.png" alt="Your Company" />
              <h2 class="mt-10 text-center text-2xl font-medium primary-color leading-9 tracking-tight text-gray-900">
                Login Account
              </h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form class="space-y-6 h-auto" action="#" method="POST">
                <div>
                  <div class="relative flex items-center mt-2">
                    <span class="absolute icon-[circum--user]">
                      <svg class="w-5 h-5 mx-3" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 48 48">
                        <g fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                          ...
                          <rect width="37" height="31" x="5.5" y="8.5" fill="none" stroke="grey" stroke-linecap="round"
                            stroke-linejoin="round" rx="4" ry="4" />
                        </g>
                      </svg>
                    </span>
                    <input id="email" name="email" type="email" autocomplete="email" required
                      class="block w-full rounded-md border-0 py-3 px-11 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      placeholder="Email" />
                  </div>
                </div>
                ...
                <div>
                  <div class="relative flex items-center mt-2">
                    <span class="absolute icon-[circum--user]">
                      <svg class="w-5 h-5 mx-3" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <g fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="1">
                          <path d="M12 11.543A2.17 2.17 0 1 0 12 7.2a2.17 2.17 0 0 0 0 4.342m0 .001v3.256" />
                          <path
                ...
                <div>
                  <button class="continue-application w-full bg-primary-color text-white py-3" type="submit">
                    <div>
                      <div class="pencil"></div>
                      <div class="folder mt-[-3px]">
                        <div class="top mt-[-3px]">
              ...
              <div class="grid grid-cols-2 justify-between sm:flex sm:flex-wrap gap-y-6 mt-6 text-gray-500 text-sm">
                <div class="flex-row float-left">
                  <!-- <input type="checkbox" name="" id=""> -->
                  <router-link to="/register" class="mt-px font-light text-gray-700 cursor-pointer select-none"
                    htmlFor="check">
                    Create an account
                  </router-link>
                </div>
                ...
                <div class="flex-row-reverse float-right">
                  <a href="#" class="font-regular primary-color flex-row-reverse hover:text-blue-70">Forgot
                    password?</a>
                </div>
              </div>
